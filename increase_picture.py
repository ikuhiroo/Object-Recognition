...
OUTPUT_DIR = Path(CURRENT_DIR.parent/'upsample').mkdir()
...
if __name__ == '__main__':
    ...
    # フォルダ名取得
    folder = [x for x in list(IMAGE_DIR.iterdir()) if x.is_dir() == True]
    print(folder)
    ...
    #
    #     base =  os.path.splitext(os.path.basename(image))[0] + "_"
    #     img_src.astype(np.float64)
    #     path = OUTPUT_DIR/base+str(i)+".jpg"
